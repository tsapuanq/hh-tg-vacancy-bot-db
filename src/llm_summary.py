...
2. "about_company" — ровно 1–2 предложения из текста, если нет → "Не указано".
3. "responsibilities" — массив из 3–5 коротких пунктов, если нет → ["Не указано"].
4. "requirements" — массив из 3–5 ключевых навыков/условий, если нет → ["Не указано"].
5. Значения должны строго соответствовать описанию. НЕ придумывай.
6. Запрещено изменять формат (например, нельзя возвращать объект с другими ключами или пустой вывод).
7. Ответ должен быть строго валидным JSON, который можно распарсить без ошибок.
